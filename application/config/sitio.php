...
$config['title']	= "Certificaciones DANE";

//Configura el nombre del sitio
$config['header']	= "Certificaciones DANE";
...
//Configuracion de fechas de inicio y fin del proceso de inscripcion
$config["inscripcion"]["fec_ini"] = "2016-02-01"; //"2016-02-11"
$config["inscripcion"]["fec_fin"] = "2016-04-03"; //"2016-04-03"

//Configuracion de fechas de inicio y fin del diligenciamiento del formulario
$config["diligenciamiento"]["fec_ini"] = "2016-02-01"; //"2016-03-01"
$config["diligenciamiento"]["fec_fin"] = "2016-03-18"; //"2016-03-19"